...
namespace Laba3
{
    public partial class Form1 : Form
    {
        ...
        int y0 = 300;
        Bitmap map;
        public void Scrolling(string Axe, List<Vector3> Points, string color,int K)
        {
            if (Axe == "X")
            {
                for (int i = 0; i < Points.Count; i++)
                {
                    Points[i] = Matrix3x3.CreateRotationX(trackBar1.Value - K) * Points[i];
                }
            }
            ...
            if (Axe == "Y")
            {
                for (int i = 0; i < Points.Count; i++)
                {
                    Points[i] = Matrix3x3.CreateRotationY(trackBar2.Value - K) * Points[i];
                }
            }
            if (Axe == "Z")
            {
                for (int i = 0; i < Points.Count; i++)
                {
                    Points[i] = Matrix3x3.CreateRotationZ(trackBar3.Value - K) * Points[i];
                }
            }
        ...
        void XYZ()
        {
            ...
            Vector3 OZ = new Vector3(0, 0, -250);
            Vector3 OY = new Vector3(250, 0, 0);
            Vector3 OX = new Vector3(0, 250, 0);
            Axes_3D_.Add(O0);
            Axes_3D_.Add(OZ);
            Axes_3D_.Add(OY);
            Axes_3D_.Add(OX);
        ...
        private void trackBar1_Scroll(object sender, EventArgs e)
        {
            ...
            {
                Axes_3D_[i]= Matrix3x3.CreateRotationX(trackBar1.Value-K1) * Axes_3D_[i];
            }
            List<PointF> b = new List<PointF>();
            b = T_2D(Axes_3D_);
            line(new PointF(b[0].X + x0, b[0].Y + y0), new PointF(b[1].X + x0, b[1].Y + y0), "Red");
            ...
            Scrolling("X", P, "Violet", K1);
            Scrolling("X", P_Bezie, "Bisque",K1);
            Scrolling("X", P_Bsplain2, "Aquamarine", K1);
            Scrolling("X", P_Bsplain3, "DarkCyan", K1);
        ...
        private void trackBar2_Scroll(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < Axes_3D_.Count; i++)
            {
                Axes_3D_[i] = Matrix3x3.CreateRotationY(trackBar2.Value - K2) * Axes_3D_[i];
            }
            ...
            line(new PointF(b[0].X + x0, b[0].Y + y0), new PointF(b[2].X + x0, b[2].Y + y0), "Blue");
            line(new PointF(b[0].X + x0, b[0].Y + y0), new PointF(b[3].X + x0, b[3].Y + y0), "Green");
            Scrolling("Y", P,"Violet", K2);
            Scrolling("Y", P_Bezie, "Bisque", K2);
            Scrolling("Y", P_Bsplain2, "Aquamarine", K2);
            Scrolling("Y", P_Bsplain3, "DarkCyan", K2);
            pictureBox1.Image = map;
            K2 = trackBar2.Value;
        }
        ...
        private void trackBar3_Scroll(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < Axes_3D_.Count; i++)
            {
                Axes_3D_[i] = Matrix3x3.CreateRotationZ(trackBar3.Value - K3) * Axes_3D_[i];
            }
            List<PointF> b = new List<PointF>();
            b = T_2D(Axes_3D_);
            line(new PointF(b[0].X + x0, b[0].Y + y0), new PointF(b[1].X + x0, b[1].Y + y0), "Red");
            line(new PointF(b[0].X + x0, b[0].Y + y0), new PointF(b[2].X + x0, b[2].Y + y0), "Blue");
            line(new PointF(b[0].X + x0, b[0].Y + y0), new PointF(b[3].X + x0, b[3].Y + y0), "Green");
            Scrolling("Z", P, "Violet", K3);
            Scrolling("Z", P_Bezie, "Bisque", K3);
            Scrolling("Z", P_Bsplain2, "Aquamarine", K3); 
            Scrolling("Z", P_Bsplain3, "DarkCyan", K3);
        ...
        {
            Vector3 point=new Vector3(float.Parse(textBox1.Text), float.Parse(textBox2.Text), (-1)*float.Parse(textBox3.Text));
            P.Add(point);
            List<PointF> b = new List<PointF>();
            b = T_2D(P);
            for(int i=0;i<b.Count-1;i++)
            {
                line(new PointF(b[i].X + x0, b[i].Y + y0), new PointF(b[i+1].X + x0, b[i+1].Y + y0),"Violet");
            }
            pictureBox1.Image = map;
            textBox1.Text = "";
            textBox2.Text = "";
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                line(new PointF(b1[i].X + x0, b1[i].Y + y0), new PointF(b1[i + 1].X + x0, b1[i + 1].Y + y0),"Bisque");
            }
            pictureBox1.Image = map;
        }
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < b1.Count - 1; i++)
            {
                line(new PointF(b1[i].X + x0, b1[i].Y + y0), new PointF(b1[i + 1].X + x0, b1[i + 1].Y + y0),"Aquamarine");
            }
            pictureBox1.Image = map;
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < b1.Count - 1; i++)
            {
                line(new PointF(b1[i].X + x0, b1[i].Y + y0), new PointF(b1[i + 1].X + x0, b1[i + 1].Y + y0),"DarkCyan");
            }
            pictureBox1.Image = map;
        }
    }
